    ...
    'admin' => [
        'emails' => [
            ...
            'notifications' => [
                ...
                'new-order' => 'Send Order Confirmation E-mail to Customer (before payment)',
                'new-admin' => 'Send Order Confirmation Copy to Admin (as separate email, not bcc)',
                'new-payment' => 'Send Payment Confirmation to Customer (after successful payment)',
                'new-payment-admin' => 'Send Payment Confirmation Copy to Admin (after successful payment)',
